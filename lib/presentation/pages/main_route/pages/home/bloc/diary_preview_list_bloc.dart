...
@injectable
class DiaryPreviewListBloc extends Bloc<DiaryPreviewListEvent, DiaryPreviewListState> {
  final LoadDiaryPreviewListUsecase _loadDiaryPreviewListUsecase;

  DiaryPreviewListBloc(this._loadDiaryPreviewListUsecase) : super(const LoadingDiaryPreviewListState()) {
